    ...
    <body>
        ...
        <nav id="menu" class="navbar container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="#article_management" data-toggle="tab">文章管理</a>
                    </li>
                    <li>
                        <a href="#new_article" data-toggle="tab">发表文章</a>
                    </li>
                    <li>
                        <a href="#category_management" data-toggle="tab">类别管理</a>
                    </li>
                    <!--<li class="disabled">
                    ...
                    <li>
                        <a href="#recycle_bin" data-toggle="tab">回收站</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container">
            <div id="myTabContent" class="tab-content">
                ...
                <!--new_article -->
                <div class="tab-pane fade" id="new_article">
                    <form  action="" id="editContent" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="txtTitle" class="form-control" style="width:560px;float:left; border: solid 1px #ccc;" maxlength="50">
                        </div>
                        ...
                        <div><textarea rows="6" style="width:99%;" name="digest"></textarea></div>
                        <br>
                        <br>
                    </form>
                ...
                <!--article_management -->
                <div class="tab-pane fade in active" id="article_management">
                    ...
                    <div class="box">
                            <div class="row">
                                <div class="col-md-6">                                	
                                    <a href="<%=path %>/pages/blogServlet?flag=blogDetail&blogId=${article.article_id}&user_id=${article.user_id}"><h6 class="blogName">${article.article_name }(${article.date})</h6></a>
                                </div>      
                                ...
                                <div class="col-md-2">                                	
                                	<div  style="float: right;">
                                     <span><a id="a" href="updateBlog?article_id=${article.article_id }" style="padding-right: ;">编辑 |</a></span>
        ...
        function submit(){
        	...
        	var url="<%=path%>/pages/EditBlog?content="+content;
