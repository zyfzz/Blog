	...
	<div class="row">
		...
		<div id="main-content" class="col-md-9">
			...
			<div class="info" style="float: right;">
				...
				<span id="edit"><a href="postedit.jsp">编辑</a></span>
			</div>
			...
			<div id="blog-content" class="box">
				...
				<ul class="list-inline" style="margin: auto; width: 30%;">
					<li>
						...
						<%-- <a href="${pageContext.request.contextPath }/pages/blogServlet?flag=like&blogid=${blog.article_id }&likenum=${blog.like_num }">
						</a> --%>
						</a>
					</li>
					<li>
			...
			<div id="evaluate" class="box">
				...
				<div style="margin: auto; width: 80%;">
					<form method="post" action="${pageContext.request.contextPath }/pages/blogServlet?flag=addcomment&article_id=${blog.article_id}&user_id=${sessionScope.userInfo.user_id}">
						<div class="form-group">
							<textarea name="commentcontent" class="form-control" rows="4" cols="25" required="required"></textarea>
						</div>
						<input type="submit" class="btn btn-4" name="evaluate" style="float: right;" value="提交">
					</form>
				</div>
			</div>
...
<script text="text/javascript" src="../js/blog.js"></script>
<!--<script type="text/javascript" 
	src="../clipboard.js-master/dist/clipboard.min.js"></script> -->
<script>
